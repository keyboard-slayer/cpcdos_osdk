...
namespace cpinti
{
	...
	{	
		...
		bool cpinti_arreter_processus(__attribute__((unused)) unsigned long ID_KERNEL, unsigned long PID)
		{
		...
		void cpinti_set_etat_processus(__attribute__((unused)) unsigned long ID_KERNEL, unsigned long PID, unsigned long ACTION)
		{
		...
		unsigned long cpinti_get_etat_processus(__attribute__((unused)) unsigned long ID_KERNEL, unsigned long PID)
		{
